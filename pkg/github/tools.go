...
func DefaultToolsetGroup(readOnly bool, getClient GetClientFn, getGQLClient GetGQLClientFn, getRawClient raw.GetRawClientFn, t translations.TranslationHelperFunc) *toolsets.ToolsetGroup {
	...
	projects := toolsets.NewToolset("projects", "GitHub Projects V2 management tools").
		...
		AddWriteTools(
			toolsets.NewServerTool(CreateProject(getGQLClient, t)),
			...
			toolsets.NewServerTool(UpdateProjectItem(getGQLClient, t)),
			toolsets.NewServerTool(UpdateProjectItemPosition(getGQLClient, t)),
			toolsets.NewServerTool(ConvertProjectItemToIssue(getGQLClient, t)),
			toolsets.NewServerTool(UpdateProject(getGQLClient, t)),
			toolsets.NewServerTool(CreateDraftIssue(getGQLClient, t)),
			toolsets.NewServerTool(DeleteProject(getGQLClient, t)),
